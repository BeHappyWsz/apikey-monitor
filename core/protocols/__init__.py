...
1. Implement probe(base, api_key, timeout, check_path="") (and optional model_probe) in a module.
...
def _probe_openai(base, api_key, timeout, check_path=""):
    return get_protocol("openai")["probe"](base, api_key, timeout, check_path)


def _probe_anthropic(base, api_key, timeout, check_path=""):
    return get_protocol("anthropic")["probe"](base, api_key, timeout, check_path)
