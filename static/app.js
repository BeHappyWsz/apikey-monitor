...
$("#key-list").addEventListener("click", async (event) => {
  ...
  if (event.target.closest(".js-copy-codex")) return quickCopyExport(id, "codex", "Codex 配置");
  if (event.target.closest(".js-copy-claude")) return quickCopyExport(id, "claude", "Claude 配置");
